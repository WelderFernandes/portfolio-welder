...
export const projects: Project[] = [
  {
    ...
    description: 'Sistema completo para gestão de processos municipais desenvolvido com React, Node.js e PostgreSQL. Inclui módulos para protocolo, recursos humanos e controle financeiro.',
  ...
  },
  {
    ...
    description: 'Aplicativo mobile para delivery de comida desenvolvido com React Native e Expo. Backend em Node.js com Nest.js e banco PostgreSQL.',
  ...
  },
  {
    ...
    description: 'Dashboard para análise de dados com gráficos interativos. Desenvolvido com React, TypeScript e integração com APIs REST.',
...
export const experiences: Experience[] = [
  {
    ...
    description: 'Desenvolvimento e manutenção de sistemas web para gestão municipal. Responsável por implementar novas funcionalidades e otimizar performance dos sistemas existentes.',
    technologies: ['React', 'Node.js', 'PostgreSQL', 'TypeScript', 'PHP', 'Laravel']
  },
  {
    id: '2',
    ...
    period: '2021 - 2022',
    description: 'Desenvolvimento de interfaces web responsivas e sistemas acadêmicos. Colaboração em projetos de modernização da infraestrutura tecnológica da instituição.',
...
export const personalInfo = {
  ...
  description: 'Desenvolvedor apaixonado por tecnologia com experiência em React, Node.js e desenvolvimento mobile. Especializado em criar soluções web modernas e eficientes.',
